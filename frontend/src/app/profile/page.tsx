...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary">
      <Sidebar user={{ name: user.username || user.email, email: user.email }} onSignOut={logout} />
        ...
        <main className="p-6 space-y-6">
          <GlassCard className="p-6">
            ...
            <div className="space-y-4">
              <GlassInput label="Username" value={username} onChange={(e) => setUsername(e.target.value)} icon={<User className="w-4 h-4" />} />
              <GlassInput label="Email" value={user.email} disabled icon={<Mail className="w-4 h-4" />} className="opacity-60 cursor-not-allowed" />
          ...
          <GlassCard className="p-6">
            ...
            <div className="space-y-4">
              <GlassInput label="Current Password" type="password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} icon={<Lock className="w-4 h-4" />} />
              <GlassInput label="New Password" type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} icon={<Lock className="w-4 h-4" />} />
